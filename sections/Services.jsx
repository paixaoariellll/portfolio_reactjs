        ...
        >
          <div className="flex h-full flex-col glassmorphism rounded-lg text-center p-5 justify-center border border-orange-600 shadow-lg transition-all hover:-translate-y-2 shadow-slate-900">
            <div className="flex flex-col gap-y-5">
              ...
              <p className="text-gray-300 text-xl">
                Ser responsável pelo seu trabalho e tomar decisões informadas é
                importante para garantir que o projeto esteja no caminho certo.
              </p>
            </div>
          </div>
        </motion.div>
          ...
          <div className="flex h-full flex-col glassmorphism rounded-lg text-center p-5 justify-center border border-orange-600 shadow-lg transition-all hover:-translate-y-2 shadow-slate-900">
            <div className="flex flex-col gap-y-5">
              ...
              <p className="text-gray-300 text-xl">
                ...
                do trabalho e tomar decisões éticas e responsáveis ​​em relação
                ao uso de tecnologia pode ser importante para muitos
                desenvolvedores.
              </p>
            </div>
          </div>
        ...
        >
          <div className="flex h-full flex-col glassmorphism rounded-lg text-center p-5 justify-center border border-orange-600 shadow-lg transition-all hover:-translate-y-2 shadow-slate-900">
            <div className="flex flex-col gap-y-5">
              ...
              <p className="text-gray-300 text-xl">
                Ser honesto e transparente em todas as interações e trabalhar de
                forma ética é fundamental para construir relacionamentos de
          ...
          <div className="flex h-full flex-col glassmorphism rounded-lg text-center p-5 justify-center border border-orange-600 shadow-lg transition-all hover:-translate-y-2 shadow-slate-900">
            <div className="flex flex-col gap-y-5">
              ...
              <p className="text-gray-300 text-xl">
                ...
                os erros e ouvir a opinião dos outros pode ser importante para o
